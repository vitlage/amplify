...
@section('content')
    ...
    <div class="row mt-4">
        <div class="col-sm-12 col-md-8 col-lg-8">
            ...
            @if ($subscription->lastInvoice() && $subscription->lastInvoice()->lastTransaction() && $subscription->lastInvoice()->lastTransaction()->isFailed())
                @include('elements._notification', [
                    'level' => 'error',
                    'message' => $subscription->lastInvoice()->lastTransaction()->error,
                ])
            @endif
                    ...
                    @if ($subscription->isActive())
                        ...
                        @if (\Auth::user()->customer->can('changePlan', $subscription))
                            <a
                                ...
                                class="btn bg-teal-601 change_plan_button mr-10"
                                data-size="sm"
                            >
            ...
            <div class="sub-section box-style1">
                <div class="row">
