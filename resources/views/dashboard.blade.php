...
@section('content')
    ...
    <h3 class=" mb-10 mt-40" style="font-size: 3rem"><i class="icon-stats-bars4"></i> {{ trans("messages.used_quota") }}</h3>
    <p>{{ trans('messages.dashboard.credit.wording') }}</p>
    </div>
    <div class="row quota_box">
        <div class="col-sm-6 col-md-6 box-style">
    ...
    <h3 class="mt-40" style="font-size: 3rem"><i class="icon-paperplane"></i> {{ trans('messages.recently_sent_campaigns') }}</h3>
    ...
    @endif
    <h3 class="mt-40" style="font-size: 3rem"><i class="icon-address-book2"></i> {{ trans('messages.list_growth') }}</h3>
    ...
    <h3 class=" mt-40" style="font-size: 3rem"><i class="icon-podium"></i> {{ trans('messages.top_5') }}</h3>
    <div class="tabbable custom-box">
    ...
    <h3 class=" mt-40" style="font-size: 3rem"><i class="icon-history"></i> {{ trans('messages.activity_log') }}</h3>
