    ...
    <div class="row sub_section">
        <div class="col-sm-12 col-md-8">
            @if (!$domain->isVerified())
                ...
                <ul class="dotted-list topborder section section-flex custom-box2">
            ...
            @else
                ...
                <a type="button" style="" class="btn btn-mc_inline" href="{{ action('TrackingDomainController@index') }} ">{{ trans('messages.go_back') }}</a>
            @endif
        </div>
    </div>
