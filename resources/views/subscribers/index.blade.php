...
@section('content')
	...
	<form class="listing-form subscribers-list custom-box"
	...
	>
		<div class="row top-list-controls">
			...
			<div class="col-md-2 text-right">
				<a style="padding: 10px 10px;" href="{{ action("SubscriberController@create", $list->uid) }}" type="button" class="btn bg-info-800">
