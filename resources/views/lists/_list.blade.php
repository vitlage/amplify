		...
		@foreach ($lists as $key => $item)
			<tr>
				...
				<td class="text-right">
					...
					<a href="{{ action('MailListController@overview', $item->uid) }}" type="button" class="btn bg-teal-601 btn-icon">
						<i class="icon-stats-growth mr-0 pr-0"></i> {{ trans('messages.list.overview_statistics') }}</a>
					<div class="btn-group">
						<button type="button" class="btn dropdown-toggle dropdown-toggle1" data-toggle="dropdown"><span class="caret ml-0"></span></button>
