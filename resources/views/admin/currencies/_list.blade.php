		...
		@foreach ($currencies as $key => $item)
			<tr>
				...
				<td class="text-right text-nowrap" width="5%">
					@can('update', $item)
						<a href="{{ action('Admin\CurrencyController@edit', $item->uid) }}" data-popup="tooltip" title="{{ trans('messages.edit') }}" type="button" class="btn bg-grey-600 btn-icon btn-fixed"><i class="icon icon-pencil pr-0 mr-0"></i></a>
					@endcan
