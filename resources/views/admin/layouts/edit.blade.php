...
@section('content')
    <header>
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-white" style="height: 56px;">
			<a class="navbar-brand left-logo mr-0" href="#">
				...
				@else
					<img height="22" src="{{ URL::asset('images/logo_dark_blue.svg') }}" alt="">
				@endif
			</a>
			<div class="d-inline-block d-flex mr-auto align-items-center">
                ...
                <h1 class="custom-font-color">{{ $layout->subject }}</h1>
