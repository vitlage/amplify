                            ...
                            >
								@foreach ($admins as $key => $item)
									<tr>
										...
										<td class="text-right">
											@can('loginAs', $item)
												<a href="{{ action('Admin\AdminController@loginAs', $item->uid) }}" data-popup="tooltip" title="{{ trans('messages.login_as_this_admin') }}" type="button" class="btn bg-teal-600 btn-icon btn-fixed"><i class="icon icon-enter"></i></a>
											@endcan
											@can('update', $item)
												<a href="{{ action('Admin\AdminController@edit', $item->uid) }}" data-popup="tooltip" title="{{ trans('messages.edit') }}" type="button" class="btn bg-grey-600 btn-icon btn-fixed"><i class="icon icon-pencil pr-0 mr-0"></i></a>
											@endcan
