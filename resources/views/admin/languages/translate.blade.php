...
@section('content')
    ...
    <form enctype="multipart/form-data" action="{{ action('Admin\LanguageController@translate', ["id" => $language->uid, "file" => $filename]) }}" method="POST" class="form-validate-jqueryx custom-box">
        {{ csrf_field() }}
