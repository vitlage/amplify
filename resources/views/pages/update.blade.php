...
@section('content')
                ...
                <form id="update-page" action="{{ action('PageController@update', ['list_uid' => $list->uid, 'alias' => $layout->alias]) }}" method="POST" class="custom-box1 form-validate-jqueryz">
					{{ csrf_field() }}
							...
							<div class="radio_box" data-popup='tooltip' title="">
								...
								<div class="radio_more_box">
									...
									<div class="">
										...
										<button type="submit" class="btn bg-teal1 mr-10"><i class="icon-check"></i> {{ trans('messages.save_change') }}</button>
									</div>
								</div>
							</div>
						</div>
