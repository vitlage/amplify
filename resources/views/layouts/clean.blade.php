...
<head>
   ...
   <link rel="stylesheet" href="{{ asset('graindashboard/css/custom.css') }}">
</head>

<body class="">

	<!-- Page container -->
	<div class="page-container1 page-container login-container" style="margin: auto;">
		@if (\Auth::check())
			...
			<div class="content-wrapper">
				<div class="login-section">
					...
					<div class="mobile-right">
					    <img src="{{asset('assets/login.svg')}}" class="login-image" alt="">
