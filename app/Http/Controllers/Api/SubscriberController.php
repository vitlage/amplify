...
class SubscriberController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $items = \App\Model\Subscriber::search($request, $user->customer)
    ...
    public function store(Request $request)
    {
        try {
            ...
            $subscriber = \App\Model\Subscriber::where('mail_list_id', $list->id)->where('email', '=', $request->EMAIL)->first();
            ...
            if ($request->isMethod('post')) {
                ...
                if ($list->subscribe_confirmation) {
                    ...
                    try {
                        $subscriber->status = \App\Model\Subscriber::STATUS_UNCONFIRMED;
                        $subscriber->save();
                    ...
                    $subscriber->status = \App\Model\Subscriber::STATUS_SUBSCRIBED;
                    $subscriber->save();
                }
    ...
    {
        $user = \Auth::guard('api')->user();
        $subscriber = \App\Model\Subscriber::findByUid($uid);
