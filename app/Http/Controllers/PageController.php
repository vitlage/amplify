...
class PageController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $layout = \App\Model\Layout::where('alias', $request->alias)->first();
    ...
    {
        $list = \App\Model\MailList::findByUid($request->list_uid);
        $layout = \App\Model\Layout::where('alias', 'sign_up_form')->first();
        $page = \App\Model\Page::findPage($list, $layout);
    ...
    {
        $list = \App\Model\MailList::findByUid($request->list_uid);
        $layout = \App\Model\Layout::where('alias', 'sign_up_thankyou_page')->first();
        $page = \App\Model\Page::findPage($list, $layout);
        $subscriber = \App\Model\Subscriber::findByUid($request->subscriber_uid);
    ...
    public function signUpConfirmationThankyou(Request $request)
    {
        $user = $request->user();
        $list = \App\Model\MailList::findByUid($request->list_uid);
        $layout = \App\Model\Layout::where('alias', 'sign_up_confirmation_thankyou')->first();
        $page = \App\Model\Page::findPage($list, $layout);
    ...
    public function unsubscribeForm(Request $request)
    {
        ...
        $user = $request->user();
        $list = \App\Model\MailList::findByUid($request->list_uid);
        $layout = \App\Model\Layout::where('alias', 'unsubscribe_form')->first();
        $page = \App\Model\Page::findPage($list, $layout);
        $subscriber = \App\Model\Subscriber::findByUid($request->uid);
    ...
    public function profileUpdateForm(Request $request)
    {
        $user = $request->user();
        $list = \App\Model\MailList::findByUid($request->list_uid);
        $layout = \App\Model\Layout::where('alias', 'profile_update_form')->first();
        $page = \App\Model\Page::findPage($list, $layout);
        $subscriber = \App\Model\Subscriber::findByUid($request->uid);
    ...
    public function profileUpdateSuccessPage(Request $request)
    {
        $user = $request->user();
        $list = \App\Model\MailList::findByUid($request->list_uid);
        $layout = \App\Model\Layout::where('alias', 'profile_update_success_page')->first();
        $page = \App\Model\Page::findPage($list, $layout);
        $subscriber = \App\Model\Subscriber::findByUid($request->uid);
    ...
    public function profileUpdateEmailSent(Request $request)
    {
        $user = $request->user();
        $list = \App\Model\MailList::findByUid($request->list_uid);
        $layout = \App\Model\Layout::where('alias', 'profile_update_email_sent')->first();
        $page = \App\Model\Page::findPage($list, $layout);
        $subscriber = \App\Model\Subscriber::findByUid($request->uid);
