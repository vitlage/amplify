...
class LanguageController extends Controller
{
    ...
    {
        if (\Gate::denies('read', new \App\Model\Language())) {
            return $this->notAuthorized();
        }

        $items = \App\Model\Language::getAll();
    ...
    public function listing(Request $request)
    {
        ...
        $items = \App\Model\Language::search($request)->paginate($request->per_page);
    ...
    {
        $language = \App\Model\Language::findByUid($id);
    ...
    {
        $items = \App\Model\Language::whereIn('uid', explode(',', $request->uids));
    ...
    {
        $languages = \App\Model\Language::whereIn('uid', explode(',', $request->uids));
