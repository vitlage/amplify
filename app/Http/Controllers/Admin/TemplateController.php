...
class TemplateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!$request->user()->admin->can("read_all", new \App\Model\Template())) {
            $request->merge(array("admin_id" => $request->user()->admin->id));
        }

        $templates = \App\Model\Template::search($request);
    ...
    public function listing(Request $request)
    {
        ...
        $templates = \App\Model\Template::search($request)->paginate($request->per_page);
    ...
    public function edit(Request $request, $uid)
    {
        // Generate info
        $user = $request->user();
        $template = \App\Model\Template::findByUid($uid);
    ...
    public function update(Request $request, $id)
    {
        // Generate info
        $user = $request->user();
        $template = \App\Model\Template::findByUid($request->uid);
    ...
    public function delete(Request $request)
    {
        ...
        $items = \App\Model\Template::whereIn('uid', explode(',', $request->uids));
    ...
    {
        $template = \App\Model\Template::findByUid($id);
    ...
    public function sort(Request $request)
    {
        ...
        foreach ($sort as $row) {
            $item = \App\Model\Template::findByUid($row[0]);
