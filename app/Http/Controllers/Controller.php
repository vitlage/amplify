...
class Controller extends BaseController
{
    ...
    {
        $user = \App\Model\User::where('api_token', $api_token)->first();
    ...
    {
        $user = \App\Model\User::where('one_time_api_token', $token)->first();
    ...
    {
        if (\App\Model\Setting::get('remote_job_token') === $remote_job_token) {
