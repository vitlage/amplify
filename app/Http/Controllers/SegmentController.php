...
class SegmentController extends Controller
{
    ...
    {
        $list = \App\Model\MailList::findByUid($request->list_uid);
        $segments = \App\Model\Segment::search($request)->paginate($request->per_page);
    ...
    {
        $list = \App\Model\MailList::findByUid($request->list_uid);
        $segment = \App\Model\Segment::findByUid($request->uid);
    ...
    {
        $items = \App\Model\Segment::whereIn('uid', explode(',', $request->uids));
    ...
    public function export(Request $request)
    {
        ...
        // Start system job
        $job = new \App\Jobs\ExportSegmentsJob($list, $request->user()->customer, $request->input("fields"), $request->uid);
        $this->dispatch($job);
