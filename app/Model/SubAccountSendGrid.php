...
class SubAccountSendGrid extends SubAccount
{
    ...
    {
        return $this->belongsTo('App\Model\SendingServerSendGrid', 'sending_server_id');
    }
    ...
    {
        $client = new \App\Extra\SendGrid(['username' => $this->getSubAccountUsername(), 'password' => decrypt($this->password)]);
    ...
    public function getMasterApiClient()
    {
        ...
        $client = new \App\Extra\SendGrid(['api' => $master->api_key]);
