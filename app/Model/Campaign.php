...
class Campaign extends AbsCampaign
{
    ...
    {
        $this->ready();
        $job = (new \App\Jobs\RunCampaignJob($this))->delay($this->getDelayInSeconds());
        dispatch($job);
    }
    ...
    public function clearAllJobs()
    {
        ...
        $systemJobs = SystemJob::where('name', 'App\Jobs\RunCampaignJob')->where('data', $this->id)->get();
    ...
    {
        \App\Library\Tool::xcopy($template->getStoragePath(), $this->getUploadDir());
